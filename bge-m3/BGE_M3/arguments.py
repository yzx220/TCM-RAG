...
class ModelArguments:
    ...
    tcm_dimension: int = field(
        default=4,
        metadata={"help": "Dimension for TCM attributes (Nature-Flavor + Meridian + Tropism)"}
    )
    kl_weight: float = field(
        default=0.7,
        metadata={"help": "Weight for KL divergence loss"}
    )
    perplexity_weight: float = field(
        default=0.1,
        metadata={"help": "Weight for perplexity loss"}
    )
    # TCM specific arguments
    tcm_vocab_path: str = field(
        default=None,
        metadata={"help": "Path to TCM vocabulary file"}
    )
    alpha: float = field(
        default=0.5,
        metadata={"help": "Weight for TCM term indicator function"}
    )
    lambda1: float = field(
        default=0.1,
        metadata={"help": "Weight for perplexity loss"}
    ...
    lambda2: float = field(
        default=0.2,
        metadata={"help": "Weight for herb property prediction loss"}
    )
    herb_dim: int = field(
        default=4,
        metadata={"help": "Dimension for herb property vectors"}
    )
...
class DataArguments:
    ...
    tcm_term_list: str = field(
        default=None,
        metadata={"help": "Path to TCM terminology list"}
    )
